              ...
              <div>
                ...
                {workerInfo?.bank_name && (
                  <div style={{fontSize:'13px', color:'#374151'}}>
                    振込先：{workerInfo.bank_name}　{workerInfo.branch_name}　{workerInfo.account_type}　{workerInfo.account_number}
                  </div>
                )}
              </div>
            ...
            <div style={{background:'white', border:'1px solid #e5e7eb', borderRadius:'8px', padding:'16px', marginBottom:'24px'}}>
              <div style={{display:'flex', gap:'32px', flexWrap:'wrap'}}>
                ...
                <div>
                  ...
                  <div style={{fontSize:'20px', fontWeight:'bold', color:'#10b981'}}>¥{totalPaid.toLocaleString()}</div>
                </div>
                <div>
                  <div style={{fontSize:'12px', color:'#6b7280'}}>差引残高</div>
                  <div style={{fontSize:'20px', fontWeight:'bold', color: balance > 0 ? '#ef4444' : '#374151'}}>¥{balance.toLocaleString()}</div>
                </div>
              </div>
            </div>
